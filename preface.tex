...
\todo{what are my contributions, what is new?}

The program tends to rely on complex, rigid models by the author's personal preference, and also because models with more free parameters would require too much training data.
...
It is possible and sometimes more robust to use an appearance-based method \todo{\dots}
...
In near infrared light, \todo{\dots}
...
\section{Notation}
\todo{describe all math notation used}
