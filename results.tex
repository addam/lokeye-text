...
For this reason, we annotated each of our testing samples with in following regards:
\begin{itemize}
\item Iris brightness
\item \todo{more}
\end{itemize}
Obviously, each eye sample has already been labeled with the iris radius.
