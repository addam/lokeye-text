...
We assume that the user is working with their personal computer, or a similar device such as a tablet.
...
\item
Moiré.
In low- and mid-cost cameras, image colors are obtained by attaching different color filters to each cell of the light sensor.
...
This effect can hardly cause any issues when displaying human faces.
...
In order to apply classic optimization methods, we need to geometrically transform (i.e., stretch) the image and its partial derivatives.
