...
The function $\f{cart}$ has been formulated Definition \ref{d:cart}.
\end{definition}
...
And finally, since even the normalized estimation need not be perfect, we locally minimize the geometric error of $\mat H$ by gradient descent.
