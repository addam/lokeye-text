...
\usepackage[numbers,sort,semicolon]{natbib}         % citation style AUTHOR (YEAR), or AUTHOR [NUMBER]
...
\usepackage{tabularx}       % 'x' column type
...
The resulting software is freely available including its source code.
}
