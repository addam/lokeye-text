...
This approach is popular both among amateurs \cite{yucel09,wolski16}\todo{more citations\dots} and in high performance industrial tools \cite{tobii}.\footnote{
The algorithm behind the software \cite{tobii} has not been published.
Our claim is based on own research.
}
\todo{talk some more about tobii: it was the first single camera tracker. We have the recorded videos.}
