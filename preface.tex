...
For matrix algebra we follow the notation used in the classical book Multiple View Geometry \cite{MVG}.
...
\todo{Something more: $\textrm{vec}, \diag, \omega root of unity$}
